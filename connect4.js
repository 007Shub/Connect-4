...
function __asyncjs__web_read_int() { return Asyncify.handleAsync(async () => { const line = await Module.readLine(); const n = parseInt(line, 10); return (line === null || String(line).trim() === "" || Number.isNaN(n)) ? -999999 : n; }); }
